    ...
    name:"sign",
     ...
     reducers:{
        ...
        isLogin:(state,action)=>{
           const {name,userRole} = action.payload
           state.loggedin = {name,userRole,success:true};
        },
...
export const {changeloginError,changeloginErrorMessage,isLogin,changeregisterError,changeregisterErrorMessage,changeEmail,changeloginPassword,changePhoneNumber,changeregisterUsername,changeRole,changeregisterPassword,changeloginUsername,} = signSlice.actions
